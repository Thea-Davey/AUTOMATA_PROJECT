...
const DFA_EDGES_2 = [
    ...
    { from: 's3', to: 's2', label: '0', arrows: 'to' },
    { from: 's4', to: 's1', label: '1', arrows: 'to' },
...
const PDA_NODES_1 = [
    ...
    { id: 'r1', label: 'READ1', x: -300, y: 0, group: 'pdaDiamond' },
    { id: 'r2', label: 'READ2', x: -300, y: 180, group: 'pdaDiamond' },

    // Column 3 (Central Hub & Vertical Stack)
    { id: 'r3', label: 'READ3', x: 0, y: -360, group: 'pdaDiamond' },
    { id: 'r4', label: 'READ4', x: 0, y: -180, group: 'pdaDiamond' },
    { id: 'r5', label: 'READ5', x: 0, y: 0, group: 'pdaDiamond' },
    { id: 'r6', label: 'READ6', x: 0, y: 180, group: 'pdaDiamond' },
    { id: 'r7', label: 'READ7', x: 0, y: 360, group: 'pdaDiamond' },

    // Column 4 & 5
    { id: 'r8', label: 'READ8', x: 300, y: 0, group: 'pdaDiamond' },
    { id: 'r9', label: 'READ9', x: 600, y: 0, group: 'pdaDiamond' },

    // Column 6
    { id: 'accept', label: 'ACCEPT', x: 900, y: 0, group: 'pdaTerminator' }
];
...
const PDA_EDGES_1 = [
    ...
    // Central Stack (Upwards path 'a')
    { from: 'r5', to: 'r4', label: 'a', arrows: 'to', smooth: false },
    { from: 'r4', to: 'r3', label: 'a', arrows: 'to', smooth: false },

    // Central Stack (Downwards path 'b')
    ...
    { from: 'r7', to: 'r8', label: 'b', arrows: 'to', smooth: { type: 'horizontal', roundness: 0.4 } },
    ...
    // READ9 Loops & Accept
    { from: 'r9', to: 'r9', label: 'a, b', arrows: 'to', selfReferenceSize: 40 },
...
const PDA_NODES_2 = [
    ...
    // Column 2
    { id: 'r1', label: 'READ1', x: -300, y: -360, group: 'pdaDiamond' },
    { id: 'r2', label: 'READ2', x: -300, y: -180, group: 'pdaDiamond' },
    { id: 'r3', label: 'READ3', x: -300, y: 0, group: 'pdaDiamond' },
    { id: 'r4', label: 'READ4', x: -300, y: 180, group: 'pdaDiamond' },
    { id: 'r5', label: 'READ5', x: -300, y: 360, group: 'pdaDiamond' },

    // Column 3
    { id: 'r6', label: 'READ6', x: 0, y: -180, group: 'pdaDiamond' },
    { id: 'r7', label: 'READ7', x: 0, y: 0, group: 'pdaDiamond' },
    { id: 'r8', label: 'READ8', x: 0, y: 180, group: 'pdaDiamond' },

    // Column 4 & 5
    { id: 'r9', label: 'READ9', x: 300, y: 0, group: 'pdaDiamond' },
    { id: 'r10', label: 'READ10', x: 600, y: 0, group: 'pdaDiamond' },
...
const PDA_EDGES_2 = [
    { from: 'start', to: 'r3', label: '', arrows: 'to', smooth: false },

    // Col 2 internal
    { from: 'r3', to: 'r2', label: '1', arrows: 'to', smooth: false },
    { from: 'r3', to: 'r4', label: '0', arrows: 'to', smooth: false },
...
async function validateRow(buttonElement) {
    ...
    try {
        ...
        if (currentModel === 'dfa') {
            ...
            let currentState = activeCartridgeId === '1' ? 'r1' : 'r3';
